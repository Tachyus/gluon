...
Gluon.Internals.registerActivators({
  ...
  "Gluon.Schema.Enum": (a: string, b: Gluon.Schema.EnumCase[]) => new Gluon.Schema.Enum(a, b),
  "Gluon.Schema.Field": (a: string, b: Gluon.Schema.DataType) => new Gluon.Schema.Field(a, b),
